(function () {
    ...
    // localStorage.setItem('user_sname','Seydalieva');
    // localStorage.setItem('user_age','32');
    // localStorage.setItem('user_adress','Karakl');
...
const chek_addres=localStorage.getItem('addres');

if(chek_name || chek_sname || chek_number || chek_addres){
    ...
    document.querySelector("[name = 'addres']").value = chek_addres;
   }
